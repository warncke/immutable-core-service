...
function initializeAll () {
    ...
    return servicesAll(service => initializeService)
...
function initializeService (service) {
    ...
    service.initializePromise = service.initialize()
    ...
    .then(data => {
        ...
        // if data is not defined then do not set
        if (!defined(data)) {
            return
        }
        // get id of data
